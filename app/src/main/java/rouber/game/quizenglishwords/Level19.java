...
public class Level19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textLevels = findViewById(R.id.text_levels); // текст Уровень 19
        textLevels.setText(R.string.level_19);
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.stairs);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level19);
        ...
        textdescriptionEnd.setText(R.string.level19end);
        //кнопка продолжить
        ...
        img_left.setImageResource(array.images19[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower19[numLeft]);
        ...
        textRight.setText(array.rusPower19[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower19[numRight]);
        } else {
            textTop.setText(array.engPower19[numLeft]);
        }
