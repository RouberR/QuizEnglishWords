...
public class Level29 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textLevels = findViewById(R.id.text_levels); // текст Уровень 20
        textLevels.setText(R.string.level_29);
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.island);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level29);
        ...
        textdescriptionEnd.setText(R.string.level29end);
        //кнопка продолжить
        ...
        numLeft = random.nextInt(45);
        img_left.setImageResource(array.images29[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower29[numLeft]);

        numRight = random.nextInt(45);

        while(numLeft == numRight){
            numRight=random.nextInt(45);
        }
        img_right.setImageResource(array.images29[numRight]);
        textRight.setText(array.rusPower29[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower29[numRight]);
        } else {
            textTop.setText(array.engPower29[numLeft]);
        }
