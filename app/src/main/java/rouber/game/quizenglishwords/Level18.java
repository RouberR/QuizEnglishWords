...
public class Level18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLevels.setText(R.string.level_18);
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.socket);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level18);
        ...
        textdescriptionEnd.setText(R.string.level18end);
        //кнопка продолжить
        ...
        img_left.setImageResource(array.images18[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower18[numLeft]);
        ...
        img_right.setImageResource(array.images18[numRight]);
        textRight.setText(array.rusPower18[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower18[numRight]);
        } else {
            textTop.setText(array.engPower18[numLeft]);
        }
