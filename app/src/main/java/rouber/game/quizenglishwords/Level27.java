...
public class Level27 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textLevels = findViewById(R.id.text_levels); // текст Уровень 27
        textLevels.setText(R.string.level_27);
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.king);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level27);
        ...
        textdescriptionEnd.setText(R.string.level27end);
        //кнопка продолжить
        ...
        img_left.setImageResource(array.images27[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower27[numLeft]);
        ...
        img_right.setImageResource(array.images27[numRight]);
        textRight.setText(array.rusPower27[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower27[numRight]);
        } else {
            textTop.setText(array.engPower27[numLeft]);
        }
