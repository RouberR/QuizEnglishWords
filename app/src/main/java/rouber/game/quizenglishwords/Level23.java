...
public class Level23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLevels.setText(R.string.level_23);
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.bald);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level23);
        ...
        textdescriptionEnd.setText(R.string.level23end);
        //кнопка продолжить
        ...
        img_left.setImageResource(array.images23[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower23[numLeft]);
        ...
        img_right.setImageResource(array.images23[numRight]);
        textRight.setText(array.rusPower23[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower23[numRight]);
        } else {
            textTop.setText(array.engPower23[numLeft]);
        }
