...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textLevels = findViewById(R.id.text_levels); // текст Уровень 3
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.parrot);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level3);
      ...
      /*  TextView textdescriptionEnd = dialogEnd.findViewById(R.id.txtdescription_end);
        ...
        img_left.setImageResource(array.images3[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower3[numLeft]);
        ...
        textRight.setText(array.rusPower3[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower3[numRight]);
        } else {
            textTop.setText(array.engPower3[numLeft]);
        }
