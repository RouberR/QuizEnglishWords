...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLevels.setText(R.string.level_6);
...
// описание задания
        ...
        img_left.setImageResource(array.images6[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower6[numLeft]);
        ...
        textRight.setText(array.rusPower6[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower6[numRight]);
        } else {
            textTop.setText(array.engPower6[numLeft]);
        }
