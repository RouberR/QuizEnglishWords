...
public class Level25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLevels.setText(R.string.level_25);
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.heart);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level25);
        ...
        textdescriptionEnd.setText(R.string.level25end);
        //кнопка продолжить
        ...
        img_left.setImageResource(array.images25[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower25[numLeft]);
        ...
        img_right.setImageResource(array.images25[numRight]);
        textRight.setText(array.rusPower25[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower25[numRight]);
        } else {
            textTop.setText(array.engPower25[numLeft]);
        }
