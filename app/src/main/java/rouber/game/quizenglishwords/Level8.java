...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.chips);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level8);
        ...
        img_left.setImageResource(array.images8[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower8[numLeft]);
        ...
        textRight.setText(array.rusPower8[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower8[numRight]);
        } else {
            textTop.setText(array.engPower8[numLeft]);
        }
