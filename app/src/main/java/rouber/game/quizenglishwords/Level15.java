...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.dress);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level15);
        ...
        img_left.setImageResource(array.images15[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower15[numLeft]);
        ...
        textRight.setText(array.rusPower15[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower15[numRight]);
        } else {
            textTop.setText(array.engPower15[numLeft]);
        }
