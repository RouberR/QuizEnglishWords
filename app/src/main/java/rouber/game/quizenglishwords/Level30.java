...
public class Level30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textLevels = findViewById(R.id.text_levels); // текст Уровень 30
        textLevels.setText(R.string.level_30);
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.way);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level30);
        ...
        textdescriptionEnd.setText(R.string.level30end);
        //кнопка продолжить
        ...
        numLeft = random.nextInt(345);
        img_left.setImageResource(array.images30[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower30[numLeft]);

        numRight = random.nextInt(345);

        while(numLeft == numRight){
            numRight=random.nextInt(345);
        }
        img_right.setImageResource(array.images30[numRight]);
        textRight.setText(array.rusPower30[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower30[numRight]);
        } else {
            textTop.setText(array.engPower30[numLeft]);
        }
