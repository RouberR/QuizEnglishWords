...
public class Level28 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textLevels = findViewById(R.id.text_levels); // текст Уровень 28
        textLevels.setText(R.string.level_28);
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.gloom);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level28);
        ...
        textdescriptionEnd.setText(R.string.level28end);
        //кнопка продолжить
        ...
        img_left.setImageResource(array.images28[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower28[numLeft]);
        ...
        img_right.setImageResource(array.images28[numRight]);
        textRight.setText(array.rusPower28[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower28[numRight]);
        } else {
            textTop.setText(array.engPower28[numLeft]);
        }
