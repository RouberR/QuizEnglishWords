...
public class Level13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textLevels = findViewById(R.id.text_levels); // текст Уровень 13
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.cushion);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level13);
        ...
        img_left.setImageResource(array.images13[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower13[numLeft]);
        ...
        img_right.setImageResource(array.images13[numRight]);
        textRight.setText(array.rusPower13[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower13[numRight]);
        } else {
            textTop.setText(array.engPower13[numLeft]);
        }
