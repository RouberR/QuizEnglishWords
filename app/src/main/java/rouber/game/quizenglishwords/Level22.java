...
public class Level22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textLevels = findViewById(R.id.text_levels); // текст Уровень 22
        textLevels.setText(R.string.level_22);
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.butcher);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level22);
        ...
        textdescriptionEnd.setText(R.string.level22end);
        //кнопка продолжить
        ...
        img_left.setImageResource(array.images22[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower22[numLeft]);
        ...
        img_right.setImageResource(array.images22[numRight]);
        textRight.setText(array.rusPower22[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower22[numRight]);
        } else {
            textTop.setText(array.engPower22[numLeft]);
        }
