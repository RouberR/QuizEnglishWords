...
public class Level26 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textLevels = findViewById(R.id.text_levels); // текст Уровень 26
        textLevels.setText(R.string.level_26);
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.lazy);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level26);
        ...
        img_left.setImageResource(array.images26[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower26[numLeft]);
        ...
        img_right.setImageResource(array.images26[numRight]);
        textRight.setText(array.rusPower26[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower26[numRight]);
        } else {
            textTop.setText(array.engPower26[numLeft]);
        }
