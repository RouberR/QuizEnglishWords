...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.belt);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level14);
        ...
        img_left.setImageResource(array.images14[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower14[numLeft]);
        ...
        img_right.setImageResource(array.images14[numRight]);
        textRight.setText(array.rusPower14[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower14[numRight]);
        } else {
            textTop.setText(array.engPower14[numLeft]);
        }
