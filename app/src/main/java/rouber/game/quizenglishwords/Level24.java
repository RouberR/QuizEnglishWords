...
public class Level24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textLevels.setText(R.string.level_24);
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.brain);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level24);
        ...
        textdescriptionEnd.setText(R.string.level24end);
        //кнопка продолжить
        ...
        img_left.setImageResource(array.images24[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower24[numLeft]);
        ...
        img_right.setImageResource(array.images24[numRight]);
        textRight.setText(array.rusPower24[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower24[numRight]);
        } else {
            textTop.setText(array.engPower24[numLeft]);
        }
