...
public class Level21 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textLevels = findViewById(R.id.text_levels); // текст Уровень 21
        textLevels.setText(R.string.level_21);
...
//Установка картинки в диалог окно
        ...
        previewimg.setImageResource(R.drawable.ship);


// описание задания
        TextView txtdescription = dialog.findViewById(R.id.txtdescription);
        txtdescription.setText(R.string.level21);
        ...
        textdescriptionEnd.setText(R.string.level21end);
        //кнопка продолжить
        ...
        img_left.setImageResource(array.images21[numLeft]); //Достаем картинку из массива
        textLeft.setText(array.rusPower21[numLeft]);
        ...
        img_right.setImageResource(array.images21[numRight]);
        textRight.setText(array.rusPower21[numRight]);

        numTop = random.nextInt(2);
       //0 - правая картинка     1- левая
        if (numTop == 0){
           textTop.setText(array.engPower21[numRight]);
        } else {
            textTop.setText(array.engPower21[numLeft]);
        }
